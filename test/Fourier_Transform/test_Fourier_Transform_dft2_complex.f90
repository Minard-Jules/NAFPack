...
contains
    ...
    subroutine test_cmplx_dft2_sp(error)
        ...
        complex(sp), dimension(Nx, Ny) :: signal
    ...
    subroutine test_cmplx_dft2_dp(error)
        ...
        type(Fourier_Transform) :: FT
        type(LoopMethod) :: loop_method
        complex(dp), dimension(Nx, Ny) :: signal
