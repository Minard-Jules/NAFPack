...
contains
    ...
    subroutine test_real_dft3_sp(error)
        ...
        real(sp), dimension(Nx, Ny, Nz) :: signal
    ...
    subroutine test_real_dft3_dp(error)
        ...
        type(Fourier_Transform) :: FT
        type(LoopMethod) :: loop_method
        real(dp), dimension(Nx, Ny, Nz) :: signal
