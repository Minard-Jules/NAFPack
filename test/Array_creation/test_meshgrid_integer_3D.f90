...
contains
    ...
    subroutine check_meshgrid_i8_3D_ij(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
    ...
    end subroutine check_meshgrid_i8_3D_ij

    subroutine check_meshgrid_i8_3D_xy(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
        integer(i8), dimension(:), intent(in) :: x_vector, y_vector, z_vector
        integer(i8), dimension(:, :, :), intent(in) :: X, Y, Z
        integer, intent(in) :: nx, ny, nz
    ...
    subroutine check_meshgrid_i16_3D_ij(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
    ...
    end subroutine check_meshgrid_i16_3D_ij

    subroutine check_meshgrid_i16_3D_xy(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
        integer(i16), dimension(:), intent(in) :: x_vector, y_vector, z_vector
        integer(i16), dimension(:, :, :), intent(in) :: X, Y, Z
        integer, intent(in) :: nx, ny, nz
    ...
    subroutine check_meshgrid_isp_3D_ij(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
    ...
    end subroutine check_meshgrid_isp_3D_ij

    subroutine check_meshgrid_isp_3D_xy(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
        integer(isp), dimension(:), intent(in) :: x_vector, y_vector, z_vector
        integer(isp), dimension(:, :, :), intent(in) :: X, Y, Z
        integer, intent(in) :: nx, ny, nz
    ...
    subroutine check_meshgrid_idp_3D_ij(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
    ...
    end subroutine check_meshgrid_idp_3D_ij

    subroutine check_meshgrid_idp_3D_xy(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
        integer(idp), dimension(:), intent(in) :: x_vector, y_vector, z_vector
        integer(idp), dimension(:, :, :), intent(in) :: X, Y, Z
        integer, intent(in) :: nx, ny, nz
