submodule (test_meshgrid) test_meshgrid_real_3D
...
contains
    ...
    module subroutine test_meshgrid_real_sp_3D(error)
        ...
        call check_meshgrid_real_sp_3D_ij(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        deallocate(X, Y, Z)
        ...
        call check_meshgrid_real_sp_3D_xy(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        deallocate(X, Y, Z)
    ...
    subroutine check_meshgrid_real_sp_3D_ij(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
    ...
    end subroutine check_meshgrid_real_sp_3D_ij

    subroutine check_meshgrid_real_sp_3D_xy(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
        real(sp), dimension(:), intent(in) :: x_vector, y_vector, z_vector
        real(sp), dimension(:, :, :), intent(in) :: X, Y, Z
        integer, intent(in) :: nx, ny, nz
    ...
    end subroutine check_meshgrid_real_sp_3D_xy
    ...
    module subroutine test_meshgrid_real_dp_3D(error)
        ...
        loop_method = init_loop_method(use_do_classic=.true.)
        call meshgrid(x_vector, y_vector, z_vector, X, Y, Z, indexing=INDEXING_IJ, loop_method=loop_method)
        call check_meshgrid_real_dp_3D_ij(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        deallocate(X, Y, Z)
        ...
        loop_method = init_loop_method(use_do_classic=.true.)
        call meshgrid(x_vector, y_vector, z_vector, X, Y, Z, indexing=INDEXING_XY, loop_method=loop_method)
        call check_meshgrid_real_dp_3D_xy(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        deallocate(X, Y, Z)
    ...
    subroutine check_meshgrid_real_dp_3D_ij(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
    ...
    end subroutine check_meshgrid_real_dp_3D_ij

    subroutine check_meshgrid_real_dp_3D_xy(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
        real(dp), dimension(:), intent(in) :: x_vector, y_vector, z_vector
        real(dp), dimension(:, :, :), intent(in) :: X, Y, Z
        integer, intent(in) :: nx, ny, nz
    ...
    end subroutine check_meshgrid_real_dp_3D_xy
    ...
    module subroutine test_meshgrid_real_qp_3D(error)
        ...
        loop_method = init_loop_method(use_do_classic=.true.)
        call meshgrid(x_vector, y_vector, z_vector, X, Y, Z, indexing=INDEXING_IJ, loop_method=loop_method)
        call check_meshgrid_real_qp_3D_ij(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        deallocate(X, Y, Z)
        ...
        loop_method = init_loop_method(use_do_classic=.true.)
        call meshgrid(x_vector, y_vector, z_vector, X, Y, Z, indexing=INDEXING_XY, loop_method=loop_method)
        call check_meshgrid_real_qp_3D_xy(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        deallocate(X, Y, Z)
    ...
    subroutine check_meshgrid_real_qp_3D_ij(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
    ...
    end subroutine check_meshgrid_real_qp_3D_ij

    subroutine check_meshgrid_real_qp_3D_xy(error, x_vector, y_vector, z_vector, X, Y, Z, nx, ny, nz)
        type(error_type), allocatable, intent(out) :: error
        real(qp), dimension(:), intent(in) :: x_vector, y_vector, z_vector
        real(qp), dimension(:, :, :), intent(in) :: X, Y, Z
        integer, intent(in) :: nx, ny, nz
    ...
    end subroutine check_meshgrid_real_qp_3D_xy

end submodule test_meshgrid_real_3D