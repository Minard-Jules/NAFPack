submodule(test_realloc) test_memory_management_complex_2D
...
contains
    ...
    module subroutine test_realloc_complex_sp_2D_grow(error)
        ...
        do j = 1, m1
            array(:, j) = [(cmplx(i + j, i+1, sp), i=1, n1)]
        end do
        ...
        do j = 1, m1
            do i = 1, n1
                call check(error, array(i, j) == cmplx(i + j, i+1, sp))
                if (allocated(error)) return
            end do
        end do
    ...
    module subroutine test_realloc_complex_dp_2D_grow(error)
        ...
        allocate (array(n1, m1))
        do j = 1, m1
            array(:, j) = [(cmplx(i + j, i+1, dp), i=1, n1)]
        end do
        call realloc(array, [n2, m2])
        ...
        do j = 1, m1
            do i = 1, n1
                call check(error, array(i, j) == cmplx(i + j, i+1, dp))
                if (allocated(error)) return
            end do
        end do
    ...
    module subroutine test_realloc_complex_qp_2D_grow(error)
        ...
        allocate (array(n1, m1))
        do j = 1, m1
            array(:, j) = [(cmplx(i + j, i+1, qp), i=1, n1)]
        end do
        call realloc(array, [n2, m2])
        ...
        do j = 1, m1
            do i = 1, n1
                call check(error, array(i, j) == cmplx(i + j, i+1, qp))
                if (allocated(error)) return
            end do
        end do
...
end submodule test_memory_management_complex_2D
